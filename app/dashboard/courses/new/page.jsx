...
import {
  ArrowLeft, BookOpen, Save, Loader2,
  AlertCircle, CheckCircle2, Plus, Trash2, Search, UserCheck, X,
} from "lucide-react";
import { useLocale } from "@/context/LocaleContext";
import { useUser } from "@/context/UserContext";
import { createCourse, fetchCourseCategories, fetchInstructors } from "@/utils/academyApi";
...
export default function NewCoursePage() {
  ...
  useEffect(() => {
    ...
    fetchInstructors().then(setInstructorPool);
  }, []);
  ...
  return (
    <div className="max-w-[860px] mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3 dash-anim-up" style={{ animationDelay: "0s" }}>
        ...
        >
          <ArrowLeft size={13} /> {t("dash_back_to_courses")}
        </Link>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-end gap-3 dash-anim-up" style={{ animationDelay: "0.1s" }}>
          ...
          >
            ...
            {submitting ? t("dash_saving") : t("dash_save_course")}
          </button>
        </div>
